...
export class GalleriesCardsComponent implements OnInit, OnChanges {
  ...
  private setHeadings(): void {
    const headings: Record<string, { h1: string; sub: string }> = {
      'Weddings': { h1: 'Сватбен фотограф', sub: 'Сватбени галерии от Виктория Борисова' },
      'Graduates': { h1: 'Фотограф за абитуриентски бал', sub: 'Галерии с абитуриентски фотосесии от Виктория Борисова' },
      'Personal': { h1: 'Други събития', sub: 'Галерии с индивидуални фотосесии, рождени дни, кръщенета и други събития от Виктория Борисова' },
      'Baptisms': { h1: 'Фотограф за кръщене', sub: 'Кръщенета и семейни тайнства' },
      'Birthdays': { h1: 'Фотограф за рожден ден', sub: 'Детски рождени дни, юбилеи и семейни празненства' },
      'Family': { h1: 'Семеен фотограф', sub: 'Семейни и детски фотосесии' },
    };
